...
@OpenAPIDefinition(
    info = @Info(
        title = "mhipsteropenid",
        version = "0.0",
        description = "mhipsteropenid API"
    )
)
public class MhipsteropenidApp {

    private static final Logger log = LoggerFactory.getLogger(MhipsteropenidApp.class);

    /**
     * Initializes MhipsteropenidApp.
     * <p>
    ...
    public static void main(String[] args) {
        ...
        ApplicationContext context = Micronaut.build(args)
            .mainClass(MhipsteropenidApp.class)
